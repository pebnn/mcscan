...
DEFAULT_SUPPORTED_PROTOCOL_VERSIONS: List[Tuple[int, str]] = [
    ...
    # 1.16.x series
    (754, "1.16.5/1.16.4"),
    # Older 1.16.x protocols are covered by VERSION_TO_PROTOCOL and/or remote data

    # 1.13.x / 1.12.x series (minimum we care about)
    (404, "1.13.2"),
    (401, "1.13.1"),
    (393, "1.13"),
    (340, "1.12.2"),
...
DEFAULT_PROTOCOL_VERSION = 773  # 1.21.9/1.21.10
